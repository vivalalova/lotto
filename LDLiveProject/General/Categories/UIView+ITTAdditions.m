...
- (void)layoutAllSubviewsLeftAdjustScreen
{
    for (UIView *subView in self.subviews) {
        if(![subView isKindOfClass:[UIView class]]){
            continue ;
        }
        subView.left =(double)subView.left /320*SCREEN_WIDTH;
    }
}
- (void)layoutAllSubviewsWidthAdjustScreen
{
    self.width = (double)self.width/320*SCREEN_WIDTH;
}
@end
