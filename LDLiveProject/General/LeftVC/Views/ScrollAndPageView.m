...
@implementation ScrollAndPageView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //设置分页
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-72,self.frame.size.height - self.frame.size.height/12- 5 , 42, 10)];
        _pageControl.userInteractionEnabled = NO;
        //设置当前显示分页的颜色
        _pageControl.currentPageIndicatorTintColor =[UIColor colorWithRed:79/255.0 green:137/255.0 blue:226/255.0 alpha:1];
