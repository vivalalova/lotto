...
@implementation CreditUsualCell
...
- (void)awakeFromNib {
    ...
    _nameViewLabel.textAlignment = NSTextAlignmentLeft;
    ...
    _creditNumViewLabel.textAlignment = NSTextAlignmentLeft;
    // Initialization code
}
...
- (void)setUsualCellUIWithImageHost:(NSString*)imageHost CreditModel:(CreditModel*)model
{
    ...
    _numLabel.text = [NSString stringWithFormat:@"NO.%@",model.rank];
