...
//        _contentView.clipsToBounds = YES;
        ...
        _contentView.backgroundColor = [UIColor colorWithHexString:@"0x2e3639"];
...
//        [_contentView addSubview:_textLabel];
        ...
        UIFont *detailFont = [UIFont systemFontOfSize:CustomFont(16)];
//        CGRect detailFrame = CGRectMake(CGRectGetMinX(textFrame),
//                                        CGRectGetMaxY(textFrame),
//                                        notificationWidth - __imagePadding * 2 - CGRectGetMaxX(_imageView.frame),
//                                        detailFont.lineHeight);
        CGRect detailFrame = CGRectMake(0, 0, SCREEN_WIDTH, 64);
