...
- (void)reloadEasyTableViewRowsAtIndexPaths:(NSArray *)indexPaths
{
    [self.tableView reloadData];
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    if (scrollView == self.tableView) {
        if ([self.delegate respondsToSelector:@selector(easyTableViewScrollViewDidEndDecelerating:)]) {
            [self.delegate easyTableViewScrollViewDidEndDecelerating:_tableView];
        }
    }
}
...
{
    if (scrollView == self.tableView) {
        if ([self.delegate respondsToSelector:@selector(easyTableViewScrollViewDidScroll:)]) {
            [self.delegate easyTableViewScrollViewDidScroll:_tableView];
        }
    }
}
