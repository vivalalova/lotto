...
-(void)contractWhatEverNoAnimation
{
    @synchronized(self){
        hidden = NO;
        isAnimating = YES;
...
- (BOOL)isTabBarExisting
{
    ...
    return tabBar && tabBar.superview && !tabBar.hidden && (tabBar.frame.origin.y != self.tabBarController.view.bounds.size.height+10);
}
