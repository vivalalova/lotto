...
static AFRequestManager *_sharedManager = nil;
...
+ (instancetype)sharedManager {
    ...
    dispatch_once(&onceToken, ^{
        //设置服务器根地址
        _sharedManager = [[AFRequestManager alloc] initWithBaseURL:[NSURL URLWithString:[URI_BASE_SERVER stringByAppendingString:URI_ROOT]]];
...
+ (NSURLSessionDataTask *)SafePOST:(NSString *)URLString
    ...
    AFRequestManager *manager = [AFRequestManager sharedManager];
    //todo 统一封装请求参数
